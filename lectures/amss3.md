...
```{code-cell} python3
:load: _static/_shared/amss2/crra_utility.py
```
...
```{code-cell} python3
---
load: _static/_shared/amss2/sequential_allocation.py
tags: [collapse-20]
---
```
...
```{code-cell} python3
---
load: _static/_shared/amss2/recursive_allocation.py
tags: [collapse-20]
---
```
...
```{code-cell} python3
---
load: _static/_shared/amss2/utilities.py
tags: [collapse-20]
---
```
...
```{figure} _static/amss3/amss3_g1.png
...
```{figure} _static/amss3/amss3_g3.png
```
...
```{figure} _static/amss3/amss3_g2.png
